""" Freeze variables and convert the network model to  GraphDef file.
...
tf.flags.DEFINE_string('pb_convert_model', 'mymodel.pb', 'the model file name after convert, default: mymodel.pb')
